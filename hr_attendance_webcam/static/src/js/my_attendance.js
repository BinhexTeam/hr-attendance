...
odoo.define("hr_attendance_webcam.my_attendance", function (require) {
    "use strict";
    ...
    MyAttendances.include({
        ...
        start: function () {
            ...
            this.getSession()
                .user_has_group(
                    "hr_attendance_webcam.group_hr_attendance_image_capture"
                )
                .then((has_group) => {
                    if (has_group) {
                        ...
                        this.cancel_button = this.modal.find(
                            ".o_hr_cancel_dialog_button"
                        );
